...
<?php if ( ! $onepress_hero_disable && ! empty ( $images ) ) : ?>
	<section id="<?php if ($onepress_hero_id != '') echo $onepress_hero_id; ?>" class="hero-slideshow-wrapper <?php if ($onepress_hero_fullscreen == 1) {
		...
		switch( $layout ) {
			...
			break;
			default:
				$hcl1_largetext  = get_theme_mod( 'onepress_hcl1_largetext', wp_kses_post('Rumah Fuki<br/><span class="js-rotating">FASILKOM UI 2016|FASILKOM UI 2016</span>', 'onepress' ));
				...
				?>
				<div class="container <?php echo 'col-lg-5' ?>"<?php echo $hero_content_style; ?>>
					<div class="hero__content hero-content-style<?php echo esc_attr( $layout ); ?>">
